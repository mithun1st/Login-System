...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Login Menu                                                 (mithun.2121@yahoo.com)");
        ...
        jLabel1.setText("Login To Your System");
    ...
    public void restore(){
        try{
            FileInputStream restore=new FileInputStream("encrypt.txt");
            ObjectInputStream r=new ObjectInputStream(restore);
            p1=(String)r.readObject();
            p2=(String)r.readObject();
            r.close();
        }
        catch(Exception e){
            System.err.println("Restore Invalid: "+e);
        }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(s1.equals(p1) && s2.equals(p2)){
            ...
            JOptionPane.showMessageDialog(null,"Password Error !","Warning",JOptionPane.ERROR_MESSAGE);
            jTextField1.setText(null);
            jPasswordField1.setText(null);
        }
    ...
    private void jPasswordField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPasswordField1KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            System.out.println("Hello Enter Button");
        }
